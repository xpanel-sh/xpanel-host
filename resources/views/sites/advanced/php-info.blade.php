...
<div class="flex grow rounded-xl bg-background border border-input lg:ms-(--sidebar-width) mt-0 lg:mt-(--header-height) m-5">
  <div class="flex flex-col grow kt-scrollable-y-auto pt-5"><main class="grow"><div class="kt-container-fluid grid gap-5">
    ...
    <div class="grid grid-cols-2 gap-3 lg:grid-cols-3"><div class="kt-card"><div class="kt-card-content p-4"><div class="text-xs text-secondary-foreground">PHP del sitio</div><div class="mt-1 text-lg font-semibold text-mono">{{ $site->type === 'php' ? $site->php_version : 'No aplica' }}</div></div></div><div class="kt-card"><div class="kt-card-content p-4"><div class="text-xs text-secondary-foreground">Motor web</div><div class="mt-1 text-lg font-semibold text-mono">{{ ucfirst($site->web_server) }}</div></div></div><div class="kt-card"><div class="kt-card-content p-4"><div class="text-xs text-secondary-foreground">Extensiones detectadas</div><div class="mt-1 text-lg font-semibold text-mono">{{ count($extensions) }}</div></div></div></div>
