...
- La terminal real (SSH por llave propia o terminal web) queda enjaulada con `bubblewrap`: cada sesión solo alcanza el document root del sitio y el de sus propios subdominios; ningún otro sitio del servidor es visible ni accesible desde ahí.
