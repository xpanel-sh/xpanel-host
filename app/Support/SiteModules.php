...
class SiteModules
{
        ...
        return [
            ...
            'advanced' => [
                ...
                'items' => [
                    ...
                    'xflow' => ['label' => 'XFlow', 'icon' => 'ki-abstract-26', 'description' => 'Automatizaciones visuales limitadas a este sitio.'],
                ],
            ],
        ];
    }
    ...
    public static function url(Site $site, string $section, string $key): string
    {
        return match (true) {
            ...
            $section === 'advanced' && $key === 'xflow' => route('sites.xflow.index', $site),
    ...
    public static function activeKey(): ?string
    {
        return match (true) {
            ...
            request()->routeIs('sites.xflow.*') => 'xflow',
    ...
    public static function isReady(string $section, string $key): bool
    {
        return in_array($section.'.'.$key, [
            ...
            'advanced.php-configuration', 'advanced.cron-jobs', 'advanced.xflow',
